...
if(alienColor ==="green"){
    ...
    console.log("you sot down yellow alien you have earned 10 points");
}
...
// Version 2
let ailenColor2 = "yellow";

if(ailenColor2 === "green"){
    console.log("you shot down green alien you have earned 5 points");
}
else if (ailenColor2 === "yellow"){
    console.log("(Version 2) you shot down yellow alien you have earned 10 points");
}
else if (ailenColor2 === "red"){
    console.log("you sot down red alien you have earned 15 points");
}

// Version 3
let alienColor3 = "red";
if(alienColor3 === "green"){
    console.log("you sot down green alien you have earned 5 points");
}
